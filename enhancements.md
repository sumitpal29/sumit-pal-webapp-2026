...
- badges should be rectangular and I can see badges has fixed width instead it should adjust according to the text. 
- currently we are showing three badges in a row, how about showing them one by one smartly enough it should not cross the width of the container. smartly placed should look beatifully utilised the space
...
- experience card - keep the company name on top, below designation- below that time period
